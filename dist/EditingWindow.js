...
import { ImageCropOverlayCustom } from './ImageCropOverlayCustom';
export function EditingWindow() {
    ...
    return (React.createElement(View, { style: styles.container },
        React.createElement(Image, { style: styles.image, source: { uri: imageData.uri }, onLayout: ({ nativeEvent }) => getImageFrame(nativeEvent.layout) }),
        isCropping && imageLayout != null ? React.createElement(ImageCropOverlayCustom, null) : null));
}
